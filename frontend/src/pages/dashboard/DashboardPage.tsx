    ...
    datasets: [
      {
        ...
        data: months.map((_, index) =>
          orderStats.RECEIVED && orderStats.RECEIVED[index + 1] ? orderStats.RECEIVED[index + 1] : 0
        ),
      ...
      },
      {
        ...
        data: months.map((_, index) =>
          orderStats.IN_PROGRESS && orderStats.IN_PROGRESS[index + 1] ? orderStats.IN_PROGRESS[index + 1] : 0
        ),
      ...
      },
      {
        ...
        data: months.map((_, index) =>
          orderStats.COMPLETED && orderStats.COMPLETED[index + 1] ? orderStats.COMPLETED[index + 1] : 0
        ),
      ...
      },
      {
        ...
        data: months.map((_, index) =>
          orderStats.CANCELED && orderStats.CANCELED[index + 1] ? orderStats.CANCELED[index + 1] : 0
        ),
